    ...
    <div className="pt-[56px] px-4 max-w-5xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        <div className={`rounded-xl border p-6 ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <FormInput 
              label="21(a). Capital/Personal Expenditure (₹)" 
              field="capitalPersonalExpenditure" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="21(b). Section 40(a) Disallowances (₹)" 
              field="section40aDisallowances" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="21(c). Section 40(b) Disallowances (₹)" 
              field="section40bDisallowances" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="21(d). Section 40A(3) Disallowance (₹)" 
              field="section40A3Disallowance" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="21(h). Section 14A Disallowance (₹)" 
              field="section14ADisallowance" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="21(i). Section 36(1)(iii) Disallowance (₹)" 
              field="section36_1_iiiDisallowance" 
              type="number" 
              placeholder="0.00" 
            />
          </div>
          ...
          <div className="mt-6">
            <FormInput 
              ...
              field="contingentLiabilities" 
              type="textarea" 
              placeholder="Details of contingent liabilities" 
            />
          </div>
        </div>
        ...
        <div className={`rounded-xl border p-6 ${
          ...
          <h2 className="text-xl font-semibold mb-6 text-orange-600">Clause 22: MSME Interest & Payments</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <FormInput 
              label="Interest Inadmissible u/s 23 (₹)" 
              field="msmeInterestInadmissible" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="Total Amount Payable to MSME (₹)" 
              field="msmeTotalPayable" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="Timely Payments (₹)" 
              field="msmeTimelyPayments" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="Delayed Payments (₹)" 
              field="msmeDelayedPayments" 
              type="number" 
              placeholder="0.00" 
            />
          </div>
        ...
        <div className={`rounded-xl border p-6 ${
          ...
          <h2 className="text-xl font-semibold mb-6 text-teal-600">Clause 30A: Transfer Pricing</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <RadioGroup
              label="30A(a). Primary adjustment made?"
              field="transferPricingAdjustment"
              options={[
                { value: 'Yes', label: 'Yes' },
                { value: 'No', label: 'No' }
              ]}
            ...
            />
            <RadioGroup
              label="30A(b)(iii). Excess money repatriated?"
              field="excessMoneyRepatriated"
              options={[
                { value: 'Yes', label: 'Yes' },
                { value: 'No', label: 'No' }
              ]}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <FormInput 
              label="30A(b)(ii). Adjustment Amount (₹)" 
              field="transferPricingAmount" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="30A(b)(v). Imputed Interest (₹)" 
              field="imputedInterest" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="30A(b)(i). Clause of Section 92CE" 
              field="transferPricingClause" 
              placeholder="Enter applicable clause" 
            />
          </div>
        </div>

        {/* Clause 30B: Interest Limitation */}
        <div className={`rounded-xl border p-6 ${
          theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
        }`}>
          <h2 className="text-xl font-semibold mb-6 text-indigo-600">Clause 30B: Interest Limitation (Section 94B)</h2>
          
          <div className="mb-6">
            <RadioGroup
              label="30B(a). Interest expenditure exceeds Rs. 1 crore?"
              field="interestExceedsOneCrore"
              options={[
                { value: 'Yes', label: 'Yes' },
                { value: 'No', label: 'No' }
              ]}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <FormInput 
              label="30B(b)(i). Interest Expenditure (₹)" 
              field="interestExpenditure" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="30B(b)(ii). EBITDA (₹)" 
              field="ebitda" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="30B(b)(iii). Excess Interest (₹)" 
              field="excessInterest" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="30B(b)(iv). Interest B/F (₹)" 
              field="interestBroughtForward" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="30B(b)(v). Interest C/F (₹)" 
              field="interestCarriedForward" 
              type="number" 
              placeholder="0.00" 
            />
          </div>
        ...
        {/* Clause 32: Loss & Carry Forward */}
        <div className={`rounded-xl border p-6 ${
          theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
        }`}>
          <h2 className="text-xl font-semibold mb-6 text-pink-600">Clause 32: Loss & Carry Forward</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <FormInput 
              label="32(a). Brought Forward Loss (₹)" 
              field="broughtForwardLoss" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="32(a). Brought Forward Depreciation (₹)" 
              field="broughtForwardDepreciation" 
              type="number" 
              placeholder="0.00" 
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <RadioGroup
              label="32(b). Shareholding change u/s 79?"
            ...
            />
            <RadioGroup
              label="32(c). Speculation loss u/s 73?"
              field="speculationLoss"
              options={[
                { value: 'Yes', label: 'Yes' },
                { value: 'No', label: 'No' }
              ]}
          ...
          <div className="mt-6">
            <FormInput 
              label="32(c). Speculation Loss Amount (₹)" 
              field="speculationLossAmount" 
              type="number" 
              placeholder="0.00" 
            />
          </div>
        ...
        <div className={`rounded-xl border p-6 ${
          ...
          <h2 className="text-xl font-semibold mb-6 text-cyan-600">Clause 34: TDS/TCS Compliance</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <RadioGroup
              label="34(a). Required to deduct/collect tax?"
              field="tdsRequired"
              options={[
                { value: 'Yes', label: 'Yes' },
                { value: 'No', label: 'No' }
            ...
            />
            <RadioGroup
              label="34(b). Required to furnish TDS/TCS statement?"
              field="tcsRequired"
              options={[
                { value: 'Yes', label: 'Yes' },
                { value: 'No', label: 'No' }
          ...
          <div className="space-y-6">
            <FormInput 
              label="34(a). TDS/TCS Details" 
              field="tdsDetails" 
              type="textarea" 
              placeholder="Provide details of TDS/TCS compliance" 
            />
            <FormInput 
              label="34(c). Interest u/s 201(1A) or 206C(7) (₹)" 
              field="tdsInterest" 
              type="number" 
              placeholder="0.00" 
            />
        ...
        <div className={`rounded-xl border p-6 ${
          ...
          <h2 className="text-xl font-semibold mb-6 text-emerald-600">Clause 40: Financial Ratios</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-medium mb-4">Current Year</h3>
            ...
            <div>
              <h3 className="text-lg font-medium mb-4">Previous Year</h3>
              <div className="space-y-4">
                <FormInput 
                  label="Previous Year Turnover (₹)" 
                  field="previousYearTurnover" 
                  type="number" 
                  placeholder="0.00" 
                />
                <FormInput 
                  label="Previous Gross Profit Ratio (%)" 
                  field="previousGrossProfitRatio" 
                  type="number" 
                  placeholder="0.00" 
                />
                <FormInput 
                  label="Previous Net Profit Ratio (%)" 
                  field="previousNetProfitRatio" 
                  type="number" 
                  placeholder="0.00" 
                />
                <FormInput 
                  label="Material Consumption Ratio" 
                  field="materialConsumptionRatio" 
                  type="number" 
                  placeholder="0.00" 
                />
              </div>
        ...
        <div className={`rounded-xl border p-6 ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <FormInput 
              label="GST Registered Entities (₹)" 
              field="gstRegisteredExpenditure" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="GST Unregistered Entities (₹)" 
              field="gstUnregisteredExpenditure" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="GST Composition Scheme (₹)" 
              field="gstCompositionExpenditure" 
              type="number" 
              placeholder="0.00" 
            />
            <FormInput 
              label="GST Exempt Supplies (₹)" 
              field="gstExemptExpenditure" 
              type="number" 
              placeholder="0.00" 
            />
          </div>
