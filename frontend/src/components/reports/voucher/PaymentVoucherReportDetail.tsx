...
import { generatePaymentXmlContent } from "../../voucherRegister/paymentXmlGenerator";
...
const PaymentVoucherReportDetail: React.FC = () => {
  ...
  const deleteHandler = async (id: string) => {
    ...
    const result = await Swal.fire({
      title: "Are you sure?",
      text: "Do you really want to delete this payment voucher?",
      icon: "warning",
  ...
  const handleExportCSV = () => {
    ...
    a.href = url;
    a.download = `Payment_Register_${monthData.monthName}_${monthData.year}.csv`;
    a.click();
  ...
  const handlePrint = () => {
    const printContent = `
      <html>
        <head>
          <title>Payment Voucher Register - ${monthData.monthName} ${monthData.year}</title>
          <style>
        ...
        <body>
          <div class="header">
            <h2>Payment Voucher Register</h2>
        ...
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-3">
              ...
              Payment Register - {monthData.monthName} {yearDisplay}
            </h1>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 pb-4 border-b border-gray-200">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Displaying all payment vouchers recorded in {monthData.monthName}.
            </p>
          </div>
                    ...
                    <tr key={v.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-3.5 whitespace-nowrap text-sm font-medium text-center">
                        <div className="flex items-center justify-center space-x-3">
                          <button
                            onClick={() => navigate(`/app/vouchers/payment/edit/${v.id}`)}
          ...
          {filteredVouchers.length === 0 && (
            <div className="text-center py-10 bg-gray-50">
              <p className="text-gray-500 text-base">
                No payment vouchers found for {monthData.monthName} {yearDisplay}.
              </p>
            </div>
          )}
        </div>
...
export default PaymentVoucherReportDetail;
