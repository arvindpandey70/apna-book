...
const ContraVoucherReport: React.FC = () => {
  ...
  const handleExportCSV = () => {
    ...
    a.href = url;
    a.download = `Contra_Voucher_Report_${selectedFinYear || "All"}.csv`;
    a.click();
  ...
  const handlePrint = () => {
    const printContent = `
      <html>
        <head>
          <title>Contra Voucher Report</title>
          <style>
          ...
          <table className="min-w-full divide-y divide-gray-200">
              ...
              {monthlySummaries.map((mSummary) => {
                return (
                  <tr
                    ...
                    onClick={() => navigate(`/app/reports/voucher/contra/detail/${mSummary.monthName}`)}
                    className="cursor-pointer hover:bg-purple-50/70 transition-colors group"
                  >
                    <td className="px-6 py-3.5 whitespace-nowrap text-sm text-gray-900 flex items-center justify-between">
                      <span className="font-medium text-purple-700 group-hover:underline flex items-center gap-1.5">
                        {mSummary.monthName}
                      </span>
            ...
            <tfoot className="bg-gray-100 border-t-2 border-gray-300 font-bold">
              <tr>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-right text-purple-700 font-bold">
...
export default ContraVoucherReport;
