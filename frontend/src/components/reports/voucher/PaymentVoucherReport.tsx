...
const PaymentVoucherReport: React.FC = () => {
  ...
  const handleExportCSV = () => {
    ...
    a.href = url;
    a.download = `Payment_Voucher_Report_${selectedFinYear || "All"}.csv`;
    a.click();
              ...
              {monthlySummaries.map((mSummary) => {
                return (
                  <tr
                    ...
                    onClick={() => navigate(`/app/reports/voucher/payment/detail/${mSummary.monthName}`)}
